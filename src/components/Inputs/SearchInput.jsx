...
function SearchInput() {
    ...
    return(
        ...
        <div className="relative inline-block min-w-[175px] w-full">
            ...
            <span onClick={() => setInputValue('')} className={`${ !inputValue.length && 'hidden' } material-icons material-icons-outlined absolute top-2/4 right-3 -translate-y-2/4 text-2xl text-gray-400 cursor-pointer peer-focus:text-blue-500`}>close</span>
        </div>
    )
}
