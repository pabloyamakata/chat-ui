...
function SearchInput() {
    ...
    return(
        ...
        <div className="relative min-w-[175px]">
            <input onFocus={activateSearch} onChange={(event) => setInputValue(event.target.value)} value={inputValue} className="focus:text-gray-200 focus:shadow-inset w-full h-11 pb-[3px] pl-[49px] pr-11 text-gray-400 bg-gray-900 rounded-full outline-0 caret-blue-500 transition-all peer" placeholder="Search" />
