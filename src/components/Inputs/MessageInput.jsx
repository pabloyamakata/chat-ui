function MessageInput() {
    return(
        <div className="relative flex items-center h-12 pt-1 px-3 rounded-xl rounded-br-none bg-gray-800">
            ...
            <input type="text" placeholder="Message" className="focus:text-gray-200 focus:outline-0 grow min-w-0 mb-1.5 pl-3 text-gray-400 bg-transparent caret-gray-400 whitespace-nowrap overflow-hidden text-ellipsis" />
