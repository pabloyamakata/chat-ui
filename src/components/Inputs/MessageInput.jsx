function MessageInput() {
    return(
        <div className="relative flex items-center h-12 pt-1 px-3 rounded-xl rounded-br-none bg-gray-800">
            <button><span className="material-icons material-icons-outlined text-gray-400">sentiment_satisfied_alt</span></button>
            ...
            <button className="pl-3"><span className="material-icons material-icons-outlined text-gray-400 rotate-45">attach_file</span></button>
