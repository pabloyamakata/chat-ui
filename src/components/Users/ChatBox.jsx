function ChatBox({ userPic }) {
    return(
        ...
        <a className="hover:bg-slate-700 flex items-center min-w-[250px] h-[72px] p-[9px] bg-gray-800 rounded-lg cursor-pointer tap-highlight-none">
            ...
            <div className="grow min-w-0 pl-2 pr-1">
